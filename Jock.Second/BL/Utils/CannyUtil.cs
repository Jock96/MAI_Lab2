namespace Bl.Utils
{
    ...
    /// <summary>
    /// Реализация метода Канни.
    /// </summary>
    public class CannyUtil
    {
        #region Поля для записи данных.
        ...
        public CannyUtil(Bitmap Input, float Th = 52,
            float Tl = 25, int GaussianMaskSize = 5,
            float SigmaforGaussianKernel = 1)
        {
        ...
        /// <summary>
        /// Получить обрабатонное изображение.
        /// </summary>
        /// <param name="GreyImage">Изображение в серых тонах.</param>
        /// <returns>Возвращает изображение с обработанными границами.</returns>
        public Bitmap GetImageWithEdges(int[,] GreyImage)
        {
            int i, j;
            int W, H;
        ...
        #region Генерация фильтра Гаусса и обработка изображения.
